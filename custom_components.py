...
def navbar():
    ...
    st.text_input("Jobsite: ", value= str(st.session_state.user_state["jobsite"]), on_change=set_jobsite, key="raw_jobsite_text_input")
    st.text_input("Area: ", value = str(st.session_state.user_state["area"]), on_change=set_area, key="raw_area_text_input")
